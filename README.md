...
| 12 | **Okul logosu** | Seçilen okul logosunu masaüstünün **sağ üst köşesinde** her oturumda küçük, çerçevesiz ve hep üstte duran bir pencerede gösterir. Tıklamaları arkadaki pencereye geçirir (input shape boş) — kullanıcıyı rahatsız etmez. Sistem geneli XDG autostart (`/etc/xdg/autostart/tiha-branding-logo.desktop`) ile kurulur, **EBA QR / USB ile sonradan oluşturulan kullanıcılar dahil her hesapta** otomatik açılır. Logo dosyası `/usr/share/tiha-branding/` altına kopyalanır, görüntüleyici betiği `/usr/local/sbin/tiha-branding-logo` (Python + GTK). Boyut 16–512 px, kenar mesafesi ayarlanabilir. **Geri al:** logo, betik ve autostart girdisi silinir, çalışan pencereler `pkill` ile kapatılır. |
...
<td><a href="docs/images/12-imaj-icin-sanitize.png"><img src="docs/images/12-imaj-icin-sanitize.png" alt="Sanitize"></a><br><sub><b>14. İmaj için sanitize</b> — kapsamlı tekil kimlik ve iz temizliği</sub></td>
</tr>
<tr>
